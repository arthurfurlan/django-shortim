...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShortURL.removed'
        db.add_column('shortim_shorturl', 'removed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShortURL.removed'
        db.delete_column('shortim_shorturl', 'removed')
