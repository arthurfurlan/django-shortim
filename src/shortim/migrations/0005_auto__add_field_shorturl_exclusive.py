...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShortURL.exclusive'
        db.add_column('shortim_shorturl', 'exclusive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShortURL.exclusive'
        db.delete_column('shortim_shorturl', 'exclusive')
